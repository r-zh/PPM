...
/**
 * Wrapper of GenericDAO to make it work together with Play, super class of all DAOs
 * 
 * <p>
 * This class takes care of the integration with play (deal with the injection of entity manager).
 * </p>
 * 
 * <p>
 * This class also implements the DAO interface which is some kind of enhancement of the GenericDAO interface.
 * </p>
 *
 * @author Peter Fu
 *
